...
from gameuniterror import GameUnitError, HealthMeterException, HutNumberNegativeError, HutNumberGreaterThatFiveError
    ...
    def _process_user_choice(self):
        ...
        while verifying_choice:
            ...
            try:
                idx = int(user_choice)
                if idx <= 0:
                    raise HutNumberNegativeError() 
                if idx > 5:
                    raise HutNumberGreaterThatFiveError()
            ...
            try:
                ...
                print("Number shoudl be in range 1-5. Try again")
                continue
